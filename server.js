...
const db = mysql.createConnection({
  host: process.env.NODE_ENV == "development" ? "localhost" : "mysql.railway.internal",
  user: "root",
  password: process.env.NODE_ENV == "development" ? "May2709488111664" : "TQEiPYwABunZrHdLvHkbXruCymdSVmmp",
  database: "account"
})
app.use(cors());
