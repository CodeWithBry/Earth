...
async function getUserLoggedIn() {
    ...
    try {
        ...
        const response = await fetch("https://earth-production-10af.up.railway.app/api/get-logged-in", {
            method: "POST",
        ...
        if (getData?.message) {
            ...
            window.location.href = "https://earth-production-10af.up.railway.app/";
        }
    } catch (error) {
        alert(error)
    }
